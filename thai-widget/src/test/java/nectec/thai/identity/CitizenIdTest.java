...
public class CitizenIdTest {
    ...
    @Test public void testInvalidFormatCitizenId() {
        assertFalse("Not Only Digit citizen-id, must be invalid",
                    CitizenId.isValid("1a3456789101b"));
        assertFalse("citizen-id length more than 13, must be invalid",
                    CitizenId.isValid("12345678910124"));
    ...
    @Test public void invalIdWithValidFormat() {
    ...
    @Test public void getCheckDigit() {
        CitizenId cid;
    ...
    @Test public void calculateCheckDigit() {
        CitizenId cid;
    ...
    @Test public void repeatNumberWithValidCheckDigit() {
        CitizenId cid;
        ...
        assertFalse("repeat pattern number with valid check digit should be Invalid",
                    cid.validate());
    }
}
